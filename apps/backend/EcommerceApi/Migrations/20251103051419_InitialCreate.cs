    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ClerkId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicableCountryCode = table.Column<string>(type: "text", nullable: true),
                    ApplicableRegionCode = table.Column<string>(type: "text", nullable: true),
                    ApplyToB2B = table.Column<bool>(type: "boolean", nullable: false),
                    ApplyToB2C = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelTaxRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChannelTaxRules_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ChannelTaxRules_Channels_ChannelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFromWebsite = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExternalVendorId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelVendors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChannelVendors_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelVendors_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliedTaxRuleName = table.Column<string>(type: "text", nullable: true),
                    AppliedTaxRate = table.Column<decimal>(type: "numeric", nullable: false),
                    TaxInclusive = table.Column<bool>(type: "boolean", nullable: false),
                    CurrencyCode = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExternalOrderId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    ExternalVariantId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelProducts_ProductId",
                table: "ChannelProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelTaxRules_CategoryId",
                table: "ChannelTaxRules",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelTaxRules_ChannelId",
                table: "ChannelTaxRules",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelVendors_ChannelId_VendorId",
                table: "ChannelVendors",
                columns: new[] { "ChannelId", "VendorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChannelVendors_VendorId",
                table: "ChannelVendors",
                column: "VendorId");
